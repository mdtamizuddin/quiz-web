...
const AddQuiz = () => {
    ...
    const { isLoading, data: allQuiz, refetch } = useQuery(['repoData'], () =>
        fetch('https://quiz-server-ouc1-8ryo6cmqm-mdtamiz.vercel.app/quiz',)
            .then(res => res.json())
    )
            ...
            <div className='p-2'>
                <div className={`flex option mt-2 items-center`}>
                    ...
                    <input
                        ...
                        checked={q.options.option1 === correct}
                    />
                ...
                <div className='flex option mt-2 items-center'>
                    ...
                    <input
                        ...
                        type="checkbox" className="checkbox"
                        checked={q.options.option2 === correct}
                    />
                ...
                <div className='flex option mt-2 items-center'>
                    ...
                    <input
                        ...
                        type="checkbox" className="checkbox"
                        checked={q.options.option3 === correct}
                    />
                ...
                <div className='flex option mt-2 items-center'>
                    ...
                    <input
                        ...
                        type="checkbox" className="checkbox"
                        checked={q.options.option4 === correct}
                    />
                        ...
                        correct
                            ...
                            correct === q.correct ?
                                ...
                                <p className='text-red-500'>
                                    Incorrect Ans. <span className='text-green-500'>
                                        Correct is : ({q.correct})
                                    </span>
                                </p>
                            :
                            ""
